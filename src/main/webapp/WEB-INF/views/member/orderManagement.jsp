...
<span class="${vo.orderProdStatus eq 0? 'correct':'' || vo.orderProdStatus eq 1? 'correct':'' 
   ...
   <form id="orderManagement">
      <span class="${vo.orderProdStatus eq 0? 'correct':'' || vo.orderProdStatus eq 1? 'correct':'' 
               ...
               <c:choose>
                  <c:when test="${vo.orderTrackingNum eq 0}">
                     <input  type="text" id="orderTrackingNum" name="orderTrackingNum" placeholder="운송장번호를 등록해 주세요"  disabled 
      ><br>
                  </c:when>
                  <c:otherwise>
                     <input  type="text" id="orderTrackingNum" name="orderTrackingNum"  value="${vo.orderTrackingNum}" required><br>
                  </c:otherwise>
               </c:choose>
            
      <br> <br>
      <select class="form-control" id="select" style="width: 400px; margin: auto; text-align: center;">
      ...
      <br>
   <br>
      <input  class="btn btn-default" type="submit" value="진행상태 변경">
