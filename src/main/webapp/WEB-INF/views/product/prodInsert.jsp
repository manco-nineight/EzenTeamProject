...
<body>
		...
		<div class="product_basic">
			<form class="form-group" id="product" action="/product/prodInsert" method="post">
				<div class="product-input">
					...
					<input class="basic-input name_input form-control" type="text" id="prodName" name="prodName" dir="rtl" oninput="nameDuplicationCheck()" required> <br>
					<span class="prodName-dub"></span>
	...
	<script type="text/javascript">
		...
		function nameDuplicationCheck() {
			...
			var yes="<tr><td colspan='3' style='color: green'>사용 가능 합니다</td></tr>";
			var no="<tr><td colspan='3' style='color: red'>중복 된 값입니다</td></tr>";
			...
			$.ajax({
				...
				success: function(result) {
					if (result == 1) {
						$(".prodName-dub").html(no);
					} else {
						$(".prodName-dub").html(yes);
					}
				}
			});
		}
