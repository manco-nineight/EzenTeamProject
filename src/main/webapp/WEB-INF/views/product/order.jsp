	...
	<div class="row">
		<form action="/product/order" method="post">
			<div class="form-group">
					<img src="${thumanail}"><br>
			
				
				<label>상품&emsp;</label>
				<input value="${vo.prodName}" name="orderProdName" readonly><br>
				<label>가격&emsp;</label>
				<input value="${vo.prodPrice}" name="orderProdPrice"readonly><br>
				<label>사이즈</label>
				<input value="${vo.prodSize}" name="orderProdSize"readonly><br>
				<label>수량&emsp;</label>
				<input value="${vo.prodQuantity}" name="orderProdQuantity"readonly><br>
			</div>
