...
<body>
   <div class="container reviewBody" >
      <div class="row">
         <h1 class="jumbotron text-center">상품명</h1>   
            
      <a class="btn btn-default review">작성&nbsp<span class="glyphicon glyphicon-pencil"></a>   
      </div>
   ...
   <div id="reviewList" class="row" style="margin: 10px -16px; width: 748px;"></div>
   <div id="reviewList_page" class="reviewList_page" style="text-align: center;"> </div>
   	<a type="button" class="btn btn-default btn reGoFirst"
				style="height: 32px; margin: -52px -16px;">처음</a>
				
	<button type="button" class="btn btn-default btn reGoLast"
				style="height: 32px; margin: -52px 666px;">마지막</button>
