...
public class OrderVO implements Serializable{
	...
	public OrderVO(int orderNum, String orderProdName, int orderProdPrice, int orderProdQuantity, int orderProdSize,
	...
	public int getOrderProdSize() {
		return orderProdSize;
	}


	public void setOrderProdSize(int orderProdSize) {
		this.orderProdSize = orderProdSize;
	}
	...
	public void setOrderTrackingNum(long orderTrackingNum) {
		this.orderTrackingNum = orderTrackingNum;
	}
