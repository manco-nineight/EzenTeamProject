			...
			<form class="form-horizontal" action="/member/loginPost" method="post">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<div class="checkbox">
							<label>
								<input type="checkbox" id="id_save_check"> Remember me
							</label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<button type="button" onclick="findId()" id="forgot_Id_btn" class="btn btn-default">ID 찾기</button>
						<button type="button" onclick="findPw()" id="forgot_Pw_btn" class="btn btn-default">비밀번호 찾기</button>
					</div>
				</div>
			</form>
		</div>
